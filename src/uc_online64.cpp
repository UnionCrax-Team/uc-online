...
bool UCOnline64::WasRestartRequested() const {
    return _restartRequested;
}

bool UCOnline64::CreateAppIdFile() {
    if (_currentAppID == 0) {
...
std::string UCOnline64::GetSteamAppIdFile() const {
    return _steamAppIdFile;
}

void UCOnline64::SetSteamAppIdFile(const std::string& appIdFilePath) {
